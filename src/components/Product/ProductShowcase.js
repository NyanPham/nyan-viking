...
export default function ProductShowcase(props) {
    const { category, collections, tags, numberToShow = null, hasButton = false, buttonText = 'Shop Now' } = props
    ...
    return (
        <>
            ...
            {hasButton && (
                <button className="px-4 py-2 mt-5 border italic border-gray-900 bg-transparent text-gray-900 mx-auto block hover:bg-gray-900 hover:text-gray-200 hover:-translate-y-0.5 transform transition">
                    {buttonText}
                </button>
            )}
        </>
